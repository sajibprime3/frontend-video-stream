<template>
  <div class="min-h-screen">
    <div class="flex py-6 px-2">
      <h1 class="text-3xl font-bold text-center">Video Gallery</h1>
      <router-link to="/upload" class="bg-blue-500 rounded-xl p-2 px-4 ml-auto">Upload</router-link>
      <router-link to="/login" class="flex bg-emerald-950 text-lime-500 rounded-xl p-2 px-4 ml-2">
        <svg fill="#007a55" height="20px" width="20px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 481.5 481.5" xml:space="preserve">
          <g>
            <path
